...
Original file is located at
    https://colab.research.google.com/drive/1CMVw8kuqYaLqFPw8Y3oWWlDD3CdTZQw7
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Machine learning/Classification/Random Forest Classification/Kyphosis project/kyphosis.csv')
...
import pickle
pickle.dump(model, open('kyphosis_rf_model.pkl','wb'))

...
Original file is located at
    https://colab.research.google.com/drive/14pNC3qGWi5EXG8zAEHXZ4onlPzJAMPJz
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Machine learning/Classification/Naive Bayes/Kyphosis project/kyphosis.csv')
...
import pickle
pickle.dump(model, open('kyphosis_naive_model.pkl','wb'))

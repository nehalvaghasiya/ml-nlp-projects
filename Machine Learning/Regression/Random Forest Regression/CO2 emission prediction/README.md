...
## Demo
<img src="https://user-images.githubusercontent.com/78668871/122126192-b2001000-ce31-11eb-8d37-c19bea67cb14.PNG" width="450"/> <img src="https://user-images.githubusercontent.com/78668871/122126453-0d320280-ce32-11eb-8f51-a174a2434a92.PNG" width="450"/>




## Overview
- This is a Random Forest Regression model. The trained model takes three parameters (Engine size, number of cylinders, fuel comsumption) as input and predict the co2 emissions(g/km) based on that.
...
├── app.py
├── model.py
├── co2_emission_Ramdom_forest_regression.ipynb
...
> - [x] Clone the repo `git clone https://github.com/nehalvaghasiya/Data-Science-Portfolio/tree/main/Machine%20Learning/Regression/Random%20Forest%20Regression/CO2%20emission%20prediction `
> - [x] Upload it to the drive that is being used with google-collab
> - [x] Run the file `"co2_emission_Ramdom_forest_regression.ipynb"` to train and test the model, use the model parameters for deployment in `"deployment_with_flask_app.ipynb"`

...
## Demo
<img src="https://user-images.githubusercontent.com/78668871/122224343-5034ba00-ceb4-11eb-9785-315fb983303f.PNG" width="450"/> <img src="https://user-images.githubusercontent.com/78668871/122224354-51fe7d80-ceb4-11eb-94cd-4c34042d8a19.PNG" width="450"/>




## Overview
- This is a K-Nearest Neighbors (K-NN) model. The trained model takes five parameters (Daily Time Spent on Site, Age, Area Income, Daily Internet Usage, Male(if its make then enter 1, otherwise 0)) as input and predict whether user has clicked on Ad or not.
...
> - [x] Clone the repo `git clone https://github.com/nehalvaghasiya/Data-Science-Portfolio/tree/main/Machine%20Learning/Classification/K-Nearest%20Neighbors%20(K-NN)/click_on_Ad_or_not `

...
Original file is located at
    https://colab.research.google.com/drive/1gmOsB1WLlViazP8SsaFgKJqu63ZIdqEw
...
data = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Machine learning/Classification/Naive Bayes/click_on_Ad_or_not/advertising.csv')

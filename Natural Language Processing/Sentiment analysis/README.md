...
## Overview
- This is the classification model which predicts the sentiment of the given text (Positive or Negative sentiment) using deep learning techniques like Recurrent Neural Networks (RNN) and Long Short-Term Memory (LSTM) in PyTorch.
...
├── app.py
├── model.py
├── sentiment analysis using deep learning - Pytorch.ipynb

...
Original file is located at
    https://colab.research.google.com/drive/10m3Wi8WPmpoE7DBRVfVPMxXILaXqaJKp
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Machine learning/Classification/Logistic Regression/Kyphosis project/kyphosis.csv')
...
import pickle
pickle.dump(model, open('kyphosis_logistic_model.pkl','wb'))
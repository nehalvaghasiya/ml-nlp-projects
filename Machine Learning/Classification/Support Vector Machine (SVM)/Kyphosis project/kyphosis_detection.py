...
Original file is located at
    https://colab.research.google.com/drive/1XYbKkIizcuh27PcJJ4VOeiE8r4WtCK4D
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Machine learning/Classification/Support Vector Machine (SVM)/Kyphosis Detection/kyphosis.csv')
...
import pickle
pickle.dump(model, open('kyphosis_SVM_model.pkl','wb'))
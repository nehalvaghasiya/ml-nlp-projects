...
Original file is located at
    https://colab.research.google.com/drive/1icjMnwBpGcN0jGORZcXMZTzI1WFDiomk
...
path = '/content/drive/MyDrive/Colab Notebooks/natural language processing/sentiment analysis/IMDB Dataset.csv' # Copy path of file IMDB Dataset.csv from the directory
df = pd.read_csv(path)
df.head()
...
'''
Padding will be done according to the max length
'''

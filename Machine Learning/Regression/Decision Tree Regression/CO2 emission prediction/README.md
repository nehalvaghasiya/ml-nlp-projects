...
## Demo
<img src="https://user-images.githubusercontent.com/78668871/122122304-ede4a680-ce2c-11eb-97b0-c1c04d6939cd.PNG" width="450"/> <img src="https://user-images.githubusercontent.com/78668871/122122312-f0470080-ce2c-11eb-944d-af68ed820fc4.PNG" width="450"/>



## Overview
- This is a Decision Tree Regression model. The trained model takes three parameters (Engine size, number of cylinders, fuel comsumption) as input and predict the co2 emissions(g/km) based on that.

## Technical Aspect
- This project is divided into two part:

> 1. Training a Decision Tree Regression model.
...
├── app.py
├── model.py
├── co2_emission_Decision_tree.ipynb
...
> - [x] Clone the repo `git clone https://github.com/nehalvaghasiya/Data-Science-Portfolio/tree/main/Machine%20Learning/Regression/Decision%20Tree%20Regression/CO2%20emission%20prediction `
> - [x] Upload it to the drive that is being used with google-collab
> - [x] Run the file `"co2_emission_Decision_tree.ipynb"` to train and test the model, use the model parameters for deployment in `"deployment_with_flask_app.ipynb"`
